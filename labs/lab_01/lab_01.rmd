...
There are a lot of classes that don't have an instructor listed. It might be better to remove all the courses that don't have an instructor listed to only see the courses with instructors. 
...
The Anthropology department had the most seats during the winter term in 2017. I want to know if Anthropology has the most seats for multiple years in a row. Would like to look at the Winter term for 2018, 2019, 2020, 2021 and 2022 specifically for Anthropology. If so, why and if not, why was Anthropology so popular during Winter 2017? 
