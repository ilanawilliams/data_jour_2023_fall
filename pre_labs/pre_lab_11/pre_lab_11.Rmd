...
**Answer**There are 999 entries that list the date, title, URL of the press release and the text for each press release
...
**Answer**lists out each version of a word that is unique
...
**Answer**pulls apart the sentences to generate a unique word or token
...
**Answer**The graph shows the count of unique words in Cardin's press releases. The graph is not interesting because the most interesting word is "the" (said over 30,000 times) and "Maryland is said the least.  
...
**Answer**We see the top 50 words. This is more interesting because we see what Cardin is talking about/what he thinks the public should know. "Health" is the most said word.  
...
**Answer**COVID was added in 2021 and in 2023 he spoke about fire and women more. Shows how topics and words matter throughout the years. 
...
**Task** Run the following code and describe the results. 
**Answer**"covid 19" was talked about the most so was "human rights" and "19 pandemic" 
...
**Task** Run the following code and describe the results. 
**Answer**"project location" is the most said phrase then "amount included" and "health care."
...
**Task** Run the following code and describe the results. 
**Answer**"human rights" was most talked about and "oral health" made an appearance. Health was mentioned as a topic in the press releases through all years given
...
**Answer**I'm not noticing any sentiments that seem incorrect. Using sentiments can be useful but sometimes a word can mean different things so it's important to note specific speeches. 
