...
In the space below, write the data type for the "id" column and the "seats" column (it's in light gray, offset by \< \>). **Answer** id is course and is shown using character and seats are shown using dbl, which is the number of seats available
...
**Answer** The year of the course and which term and the section. Shows that the Spring and Fall classes have the most students. Important because it shows how many students were registered during each term.  
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer** The most recent term is listed first 
...
**Answer** Shows 2017 during the winter session because we grouped by term and department. Grouped by adds another column
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer** Shows each year but grouped together by the same session. Able to count and add that adds a new column
...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? **Answer** Mean and median are included. Summarized added more columns. Mean and median show the average of how many seats were availble during each term. 
...
**Answer** Was grouped by department before summarizing everything listed
...
1.  Why is the school of music listed? What does it mean? 

2.  How often does UMD open its classes to hundreds more people like it did during COVID? Has this happened any other years? 

3.  Why was the winter term important during 2017?
