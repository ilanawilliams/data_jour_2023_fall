...
**Answer**four columns, over 3,000 rows
...
**Answer** mutate organizes the date into a real date, group by organizes the data you want to use, summarize does the math of organizing the month (or whatever data you group by), arrange reorganizes the data into a a certain way (in this case, total calls are shown from highest to lowest)
...
**Answer** Nothing: ggplot creates a blank space to make something
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**a bar chart with a y-axis and x-axis! so lovely except it doesn't really look like a bar chart (you described it as a skyline) and it's not in descending or ascending order. 

```{r}
baltco_911_calls_by_month |>
  ggplot() + #once you type ggplot you have to include the plus sign instead of carrot
...
**Answer**bar chart is now is in order from lowest to highest but I don't like the title of the x-axis. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? 
**Answer**moved the months to the y-axis and the total number of calls is the x-axis. I don't like this version as much, but it probably depends on the data. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? 
**Answer**Got rid of the tick marks next to the months
...
**Answer**The background is blue, the title of the axes are pushed in to the labels 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? 
**Answer**title, title of axes and added a caption
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**over 300 rows of total calls for each date
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**this is not an exact pattern, but calls seem to fall between 5 and 15. Over time, there are fewer calls. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**The dates are broken up, but the x-axis is very messy. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**Can read it, but still not great. Would not publish it
