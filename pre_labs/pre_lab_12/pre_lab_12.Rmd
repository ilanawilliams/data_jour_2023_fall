...
results <- mde_url |>
  read_html()
#why do we inspect the URL before making it a new dataframe?
...
# show the dataframe
#first has a date column and press release name
...
**Answer**The URL becomes an actual dataframe but the date column is a character
...
**Task** Run the following code to extract the table we want, clean up the names and change the date column to an actual date. Look at the dataframe; 
what other information about these releases might you want to add? 
**Answer**Filter out the press releases that show money amounts like row two and four to know how much money is being awarded to Department of Education or given to other organizations 
...
**Answer**there are four li listing items that include URL links
...
**Answer**html_text filters out all the words that are in lists
...
**Answer**Makes the dataframe but we want to isolate listing items
