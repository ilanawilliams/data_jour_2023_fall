...
https://www.datawrapper.de/_/7KGUo/ 
...
md_gov_county <- md_gov_county |> clean_names() |>
  mutate(total_votes = (cox+ moore+lashar+wallace+harding+write_ins))|> #add all the names
...
I don't think anything changed because all of the regions have data available
...
**Answer** Describe the changes from the previous map
In the previous version, the tooltip was the total number of votes for Moore and another number that did not make sense. Now, it shows the County name and the precent of votes for Moore. 
...
https://datawrapper.dwcdn.net/B1BSB/1/
