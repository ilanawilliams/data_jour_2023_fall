...
**Answer**Filter helps to narrow data so we only look at the data we want. 
...
**Answer**41011 obs. of 8 variables
...
**Answer:**Mutate allowed the year to be listed first. By telling R to change what the expenditure date is. 
...
**Answer**<date> lists the date in R and is listed with the first of each month to know the year. 
...
**Answer**The code adds all the candidates to know the total votes.The + adds all the votes for each candidates from each county. Mutate helps with this because it creates a new column for total votes and determines how many votes went to Moore. 
...
**Answer**Moore votes are in descending order because of the extra line of code to arrange Moore's votes in percent. 
...
**Answer**Not much different other than the order of the votes. 
...
2. str_to_sentence converts to sentence cases where only the first letter of a sentence is capitalized
...
**Answer**R goes in order when making new columns with states. West Virginia has to be first to avoid R including Virginia in the same column. 
...
**Answer*A little? Summarizing helps group each state without having to list all of the states. But I don't understand how we got here. 
...
1.Why does 2019 have high seat counts? 

2.Why is there a jump from $900,000 to $2,700,000 in the MD expenditure data?  

3. Why does Gerard Passannante have the most seats when looking at all the courses with "Shakesphere" in the name? How many courses does Passannante teach?
